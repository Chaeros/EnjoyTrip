package com.ssafy.enjoytrip.global.oauth2.service;
...
import com.ssafy.enjoytrip.global.oauth2.OAuthAttributes;
...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        System.out.println("asdsadsadsadsadsadsadsadsadsadsad");
        /**
    ...
    private Member getUser(OAuthAttributes attributes, SocialType socialType) {
        ...
        map.put("socialType",String.valueOf(socialType));
        map.put("socialId",attributes.getOauth2UserInfo().getId());
        Member findUser = memberMapper.findMemberBySocialTypeAndSocialId(map);
    ...
    private Member saveUser(OAuthAttributes attributes, SocialType socialType) {
        ...
        return memberMapper.save(createdUser);
    }
}